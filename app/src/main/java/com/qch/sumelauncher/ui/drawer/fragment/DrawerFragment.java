package com.qch.sumelauncher.ui.drawer.fragment;
...
public class DrawerFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.fDrawerSv.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                GridDrawerRVAdapter adapter = (GridDrawerRVAdapter) binding.fDrawerRv.getAdapter();
                if (adapter != null) {
    ...
    private void showGridMenu(@NonNull View view, @NonNull ActivityModel item) {
